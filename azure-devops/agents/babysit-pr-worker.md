...
Action — create a work item directly (do NOT use `azure-devops:draft-work-item` — it is
interactive and will stall in autonomous mode):

<work_item_creation>
**Step 1: Resolve Area Path**

The area path determines which team owns the work item. The `azure-devops:babysit-pr`
